...
def create_app(args):
    ...
    # This simply tries to download LibreTranslate models, since we use only 
    # converted OPUS models this is not necessary
    ...
    def translate_file():
        ...
        try:
            ...
            return jsonify(
                {
                    "translatedFileUrl": url_for('Main app.download_file', filename=translated_filename, _external=False)
                }
            )
        except Exception as e:
